...
import { ProfileContext } from "../generator/generator";
    ...
    <header className={styles.header}>
      <div className={styles.headerWrapper}>
        <div className={styles.logo}>
          <img src="/visuals/whiteEuro.svg" alt="Eurovision Song Generator" />
          <span>SONG CONTEST GENERATOR</span>
        </div>

        <div className={styles.spotifyLoginWrapper}>
          {profile ? (
            <div className={styles.profile}>
              ...
              <svg
                className={isArrowUp ? styles.arrow : styles.arrowUp}
                onClick={handleArrow}
                fill="#FFFFFF"
                width="20px"
                height="20px"
